			...
			<div class="inner">
				...
				<div id="info">
					...
					<div class="section">
						...
						<form style="width:900px;" class="search_form general_form" onsubmit="stuhistory();return false;">
							...
							<fieldset>
								...
								<div class="row" >
									...
									<div class="inputs">
										<span class="input_wrapper"><input class="text" name="stuid" id="stuid" placeholder="Student ID" type="text" maxlength="7" /></span>	<span class="button blue_button search_button"><span style="cursor:pointer;" onclick="stuhistory()"><span><em><span class="button_ico"></span>Search</em></span></span></span>
